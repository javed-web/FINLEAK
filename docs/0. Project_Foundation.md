...
I wanted to build a Data Analyst project that was closer to the kind of problem an analyst might actually face in a FinTech company.
...
The Python virtual environment is kept outside the project code structure and will not be committed to GitHub.
...
### **Stage D — Refunds & Chargebacks 💰**

I'll generate these as separate data layers, validate them independently, document the results, and then lock the stage before moving forward.

The same process will continue for every stage of FinLeak.
